...
- 강조는 색이 아닌 **검정 fill 박스 + 흰 텍스트 (반전)** 또는 **굵게 (weight 800~900)** 로
...
▸ ★ 완전 흑백 + 회색만 ★ — 컬러 액센트 절대 사용 금지
   ...
   - 강조도 검정 fill 로만 (#1A1A1A 박스 + #FFF 텍스트 = 반전)
...
5. 한 슬라이드 도형 수 5~30 범위 (단 표지·divider 는 5~15) 인가?
