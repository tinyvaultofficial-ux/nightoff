...
- 좌표: 본문 텍스트 영역 옆 (좌/우 분할) 또는 페이지 하단 (8~10 × 3~4 인치)
...
13. ★ 정량 lock 영역 정량을 그대로 인용했나 (행사 일자 / 행사 장소 / 예상 참가자 수 / 예산 금액 등)?
...
15. ★ N-구조 표현 (3-Track / 4-Pillar / 5-Layer / N-zone 등) 이 인접 페이지와 중복 X?
    ...
    — outline 단계 결정 메인/서브 거버닝 = 그대로 사용 (14번 정합), 다만 본문 풀이 영역 다양화.
